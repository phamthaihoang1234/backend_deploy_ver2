...
public class SendMailUtil {
	...
	static String HEADER = "<body style=\"margin: 0 !important; padding: 0 !important; background-color: #fcb800;\" bgcolor=\"#fcb800\">\r\n"
			...
			+ "                                            <p style=\"font-family: Open sans-serif; font-size: 18px;\"><em>Bạn có thể sử dụng email này và mật khẩu mặc định ban đầu là : 123@qtu để đăng nhập để có thể tra cứu đơn hàng và sử dụng nhiều dịch vụ của chúng tôi hơn</em></p>\r\n"
			+ "                                        </td>\r\n" + "                                    </tr>\r\n"
			+ "\r\n" + "                                    <tr>\r\n"
			+ "                                        <td align=\"left\" style=\"padding-top: 20px;\">\r\n"
			+ "                                            <table cellspacing=\"0\" cellpadding=\"0\" border=\"0\" width=\"100%\">\r\n"
	...
	static String FOOTER = "</tr>\r\n" + "                                                </table>\r\n"
			...
			+ "                                            <p style=\"font-size: 18px; font-weight: 800; line-height: 18px; color: #fcb800;\"> TechWorld-shop </p>\r\n"
